...
func (lgd *logDispatcher) init() {
	...
	lgd.knownTopics = map[common.Hash]func(*types.LogRecord){
		...
		crypto.Keccak256Hash(([]byte)("Delegated(address,uint256,uint256)")): handleSfcCreatedDelegation,

		/* event Undelegated(address indexed delegator, uint256 indexed toValidatorID, uint256 indexed wrID, uint256 amount) */
		crypto.Keccak256Hash(([]byte)("Undelegated(address,uint256,uint256,uint256)")): handleSfcUndelegated,
		...
		crypto.Keccak256Hash(([]byte)("Withdrawn(address,uint256,uint256,uint256,uint256)")): handleSfcWithdrawn,

		/* event Withdrawn(address indexed delegator, uint256 indexed toValidatorID, uint256 indexed wrID, uint256 amount) */
		crypto.Keccak256Hash(([]byte)("Withdrawn(address,uint256,uint256,uint256)")): handleSfcWithdrawnWoPenalty,

		/* event ClaimedRewards(address indexed delegator, uint256 indexed toValidatorID, uint256 rewards) */
		crypto.Keccak256Hash(([]byte)("ClaimedRewards(address,uint256,uint256)")): handleSfcClaimedRewards,

		/* event RestakedRewards(address indexed delegator, uint256 indexed toValidatorID, uint256 rewards) */
		crypto.Keccak256Hash(([]byte)("RestakedRewards(address,uint256,uint256)")): handleSfcRestakedRewards,
